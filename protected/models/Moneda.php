 ...
 * @property string $nb_moneda
 * @property string $simbolo
 * @property boolean $st_moneda
 *
...
class Moneda extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('nb_moneda', 'required'),
			array('nb_moneda', 'length', 'max'=>20),
			array('simbolo', 'length', 'max'=>5),
			array('st_moneda', 'safe'),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id_moneda, nb_moneda, simbolo, st_moneda', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'puntoCuentas' => array(self::HAS_MANY, 'PuntoCuenta', 'id_tp_moneda'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('nb_moneda',$this->nb_moneda,true);
		$criteria->compare('simbolo',$this->simbolo,true);
		$criteria->compare('st_moneda',$this->st_moneda);
