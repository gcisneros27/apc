...
/**
 * This is the model class for table "seguridad.authassignment".
 *
 * The followings are the available columns in table 'seguridad.authassignment':
...
class Authassignment extends CActiveRecord
{
	...
	{
		return 'seguridad.authassignment';
	}
	...
	public function rules()
	{
		...
		return array(
			...
			array('bizrule, data, usu_aud_id, usuario_id_aud', 'safe'),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('itemname, userid, bizrule, data, usu_aud_id, usuario_id_aud', 'safe', 'on'=>'search'),
		);
	}
