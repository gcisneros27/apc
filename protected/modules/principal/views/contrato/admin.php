...
<?php   echo SemanticForm::beginUiAdmin(
        'Listado de Contratos- Punto de Cuenta '.$modelPunto->co_punto_cuenta,
        $menu=array(
...
<?php $this->widget('zii.widgets.grid.CGridView', array(
	...
	'dataProvider'=>$model->search($modelPunto->id_punto_cuenta),
	...
	'columns'=>array(
		//'co_contrato',
			...
			'filter'=>
			CHtml::activeDropDownList($model,'co_contrato',CHtml::listData(Contrato::model()->findAll('id_punto_cuenta=:idp',array(':idp'=>$modelPunto->id_punto_cuenta)),'co_contrato','co_contrato'),
		...
		*/
		array(
			'class'=>'CButtonColumn',
                        'header'=>"Acción",
                        'template' => '{view}{update}{addenda}{borrar}',
                        'buttons'=>array(
                            'view' => array(
