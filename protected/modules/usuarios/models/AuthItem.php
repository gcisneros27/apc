...
class AuthItem extends CActiveRecord
{
	...
	//RETORNA LISTA DE ROLES QUE SON SUBCONJUNTO DEL USUARIO LOGUEADO
	...
	//VALIDAR SI USUARIO PUEDE SER MODIFICADO POR USUARIO LOGUEADO
	public function  validarUsuarioRol($id_usuario,$lista_roles_permitidos){

			$valido=false;
			$rol=AuthAssignment::model()->find("userid=:userid",array(":userid"=>"$id_usuario"));
	
			if ($rol&&in_array($rol->itemname, $lista_roles_permitidos)) {
					$valido=true;				
			}else if (in_array("Programador", $lista_roles_permitidos)) {
					$valido=true;
			}
			return $valido;
