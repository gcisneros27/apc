	...
	<div class="ui form">
		<div class="ui form secondary segment">
			...
			<p class="note" style="text-align:center">Los Campos con <span class="required">*</span> son obligatorios.</p>
				<div class="one field">
					<?php  echo $form->fieldTextLeft($model,'name',$disabledifisnotnew=TRUE,$htmlOptions=array('class'=>'comentario-focus','data-content'=>'Nombre de la Tarea' , "data-variation"=>"inverted","data-position"=>"left center",'placeholder'=>$model->getAttributeLabel('name')),$getPost); ?>				           
				</div>
				<div class="one field">
					<?php  echo $form->fieldTextAreaLeft($model,'description',$disabledifisnotnew=FALSE,$htmlOptions=array('style'=>"width: 100%; height: 63px;",'class'=>'comentario-focus','data-content'=>'Descripción de la Tarea' , "data-variation"=>"inverted","data-position"=>"left center",'placeholder'=>$model->getAttributeLabel('descripcion')),$getPost); ?>				           
				</div>
				
				
				<div class="span10">
					<?php
							echo $this->renderPartial('draggdropTarea', array('model'=>$model,'tareas'=>$tareas,
