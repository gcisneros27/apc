    ...
    <script src="<?php echo Yii::app()->request->baseUrl; ?>/js/jquery.dualListbox-1.3/jquery.dualListBox-1.3.min.js"></script>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo Yii::app()->request->baseUrl; ?>/js/jquery.dualListbox-1.3/styles.css" />
...
<?php $this->beginWidget('application.extensions.jui.ETabs', array('name'=>'tabpanel1')); ?>
   <?php $this->beginWidget('application.extensions.jui.ETab', array('name'=>'tab1', 'title'=>'Asignar Roles')); ?>
	...
	<table>
            <tr>
                <td  width="40%">
			Filtro: <input style="width:90%" type="text" id="box1Filter" /><button type="button" id="box1Clear">X</button><br /><br />
			...
			<button id="to1" type="button">&nbsp;<&nbsp;</button>
                ...
                <td  width="40%">
			Filtro: <input style="width:90%" type="text" id="box2Filter" /><button type="button" id="box2Clear">X</button><br /><br />
			<div>Roles Asignados</div><br/>
			<select name="roles[]" id="box2View" multiple="multiple" style="height:500px;width:100%;">
			<?php 
    ...
    <?php $this->beginWidget('application.extensions.jui.ETab', array('name'=>'tab2', 'title'=>'Asignar Tareas')); ?>

	<div>
	<table>
            <tr>
                <td width="40%">
			Filtro: <input style="width:90%" type="text" id="box3Filter" /><button type="button" id="box3Clear">X</button><br /><br />
			<div>Tareas No Asignadas</div><br/>
			<select id="box3View" multiple="multiple" style="height:500px;width:100%;">
			<?php 
			...
			<button id="to3" type="button">&nbsp;<&nbsp;</button>
                ...
                <td width="40%">
			Filtro: <input style="width:90%" type="text" id="box4Filter" /><button type="button" id="box4Clear">X</button><br /><br />
			<div>Tareas Asignadas</div><br/>
			<select name="tareas[]" id="box4View" multiple="multiple" style="height:500px;width:100%;">
			<?php 
