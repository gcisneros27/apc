<?php
class CreateTareaAction extends CAction
{
   public function run()
   {
		$model=new AuthItem;
		...
		die();
		*/
		$this->controller->render('createTarea',array(
